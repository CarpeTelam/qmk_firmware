...
#define PRV_SCN LCTL(KC_LEFT)
#define NXT_SCN RCTL(KC_RGHT)

#define NAV_1 LT(_NUMBER, KC_BSPC)
#define NAV_2 LT(_NAVIGATION, KC_DEl)
#define NAV_3 LT(_MOUSE, KC_ESC)
#define NAV_4 LT(_SHORTCUT, KC_ENT)
#define NAV_5 LT(_MEDIA, KC_TAB)
#define NAV_6 LT(_FUNCTION, KC_SPC)
